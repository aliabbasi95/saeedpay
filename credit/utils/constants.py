...
STATEMENT_PENALTY_RATE = getattr(
    settings, "CREDIT_STATEMENT_PENALTY_RATE", 0.02
)  # 2% per day
STATEMENT_MAX_PENALTY_RATE = getattr(
    settings, "CREDIT_STATEMENT_MAX_PENALTY_RATE", 0.20
)  # 20% max
...
# حداقل پرداخت
MINIMUM_PAYMENT_PERCENTAGE = getattr(settings, "MINIMUM_PAYMENT_PERCENTAGE", 0.10)
MINIMUM_PAYMENT_THRESHOLD = getattr(settings, "MINIMUM_PAYMENT_THRESHOLD", 100_000)
