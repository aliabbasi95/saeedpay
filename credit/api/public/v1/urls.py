...
from .views.credit import (
    CreditLimitListView, CreditLimitDetailView,
    StatementListView, StatementDetailView,
    StatementLineListView,
    AddPurchaseView, AddPaymentView, ApplyPenaltyView,
    CloseStatementView, RiskScoreView
)

urlpatterns = [
    path('credit-limits/', CreditLimitListView.as_view(), name='credit_limit_list'),
    path('credit-limits/<int:pk>/', CreditLimitDetailView.as_view(), name='credit_limit_detail'),
