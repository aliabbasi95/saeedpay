...
class LoanRiskReport(BaseModel):
    ...
    def mark_otp_sent(self, unique_id: str) -> None:
        ...
        self.save(update_fields=['otp_unique_id', 'otp_sent_at', 'status', 'updated_at'])
    ...
    def mark_report_requested(self, unique_id: str) -> None:
        ...
        self.save(update_fields=['report_unique_id', 'report_requested_at', 'status', 'updated_at'])
    ...
    def mark_completed(
        ...
        self.save(update_fields=[
            'credit_score', 'risk_level', 'grade_description', 'report_data',
            'report_timestamp', 'report_types', 'status', 'completed_at', 'updated_at'
        ])
    ...
    @classmethod
    def can_user_request_new_report(cls, profile, cooldown_days: int = 30) -> tuple[bool, str, 'LoanRiskReport']:
        """
