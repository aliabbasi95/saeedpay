...
class Store(
    ...
    name = models.CharField(max_length=100, verbose_name=_("نام فروشگاه"))
    code = models.CharField(
        null=True, blank=True, max_length=20, verbose_name=_("کد فروشگاه")
    )
    ...
    website_url = models.URLField(blank=True, verbose_name=_("لینک وب‌سایت فروشگاه"))
