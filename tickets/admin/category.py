...
class TicketCategoryAdmin(BaseAdmin):
    list_display = ("id", "name", "description_short", "icon_badge", "color_tag")
    list_display_links = ("id", "name")
    search_fields = ("name", "description")
    list_per_page = 30
    ordering = ("id",)
    fieldsets = ((_("اطلاعات"), {"fields": ("name", "description", "icon", "color")}),)
    ...
    def icon_badge(self, obj: TicketCategory):
        return format_html('<code style="font-size:12px">{}</code>', obj.icon or "-")
