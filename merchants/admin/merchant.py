...
class MerchantAdmin(BaseAdmin):
    list_display = ["id", "user", "get_phone", "get_national_id"]
    search_fields = ["user__username", "user__profile__national_id"]
    ...
    def get_national_id(self, obj):
        return obj.user.profile.national_id if hasattr(obj.user, "profile") else "-"
