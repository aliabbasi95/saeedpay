# apps/wallets/admin/installment_plan.py
...
from apps.wallets.models import InstallmentPlan
from apps.wallets.utils.choices import InstallmentPlanStatus
...
class InstallmentPlanAdmin(BaseAdmin):
    ...
    def total_amount_display(self, obj: InstallmentPlan):
        return format_html(
            '<span style="direction:ltr;">{:,}</span>', int(obj.total_amount or 0)
        )
