# apps/banking/api/public/v1/schema_bank_card.py
        ...
        responses={
            ...
            400: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        "InvalidCardNumber",
                        value={"card_number": ["شماره کارت نامعتبر است."]},
                    )
                ],
            ),
        },
    ...
    update=extend_schema(
        ...
        examples=[
            OpenApiExample(
                "UpdatePayload",
                request_only=True,
                value={"card_number": "6219861234567890"},
            )
        ],
    ),
        ...
        responses={
            ...
            400: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        "Pending",
                        value={"detail": "کارت‌های در حال بررسی قابل حذف نیستند."},
                    )
                ],
            ),
            404: OpenApiResponse(description="Not found."),
